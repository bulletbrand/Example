export const initialProgress = [
    {text: 'Ручное бронирование', count: '11', progress: '65%', background: '#B1E19B', border: 'green'},
    {text: 'Пакетные туры', count: '3', progress: '20%', background: '#ACE2F8', border: 'blue'},
    {text: 'Отели', count: '1', progress: '5%', background: '#ACE2F8', border: 'blue'}
];
